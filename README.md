...
1) подключаем jquery
2)подключаем 2 файла библиотеки SMP.js b SMP.css
3)
...
<body>
	<script defer>
        var template = {}
                ...
                в качестве значения устанавливае объект с двумя свойствами event - название события и функция то что будет исполняться при срабатывнии собыития
